...
var G__18740 = devtools.prefs.pref.call(null,v);
v = G__18740;
continue;
} else {
return v;
...
}catch (e18741){var _e__18481__auto__ = e18741;
return false;
}})();
...
}catch (e18743){var _e__18481__auto__ = e18743;
return false;
}})();
...
}catch (e18745){var _e__18481__auto__ = e18745;
return false;
}}
}
});
...
var vec__18747 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__18747,(0),null);
var name = cljs.core.nth.call(null,vec__18747,(1),null);
...
return cljs.core.some.call(null,(function (p1__18750_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18750_SHARP_);
}),template);
});
