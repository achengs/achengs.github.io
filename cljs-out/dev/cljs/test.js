...
var G__10669 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10669,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10669;
}
}));
...
var len__4864__auto___10674 = arguments.length;
var i__4865__auto___10675 = (0);
while(true){
if((i__4865__auto___10675 < len__4864__auto___10674)){
args__4870__auto__.push((arguments[i__4865__auto___10675]));

var G__10676 = (i__4865__auto___10675 + (1));
i__4865__auto___10675 = G__10676;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10671){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10672,G__10673,seq10671__$2);
}));
...
var map__10678 = m;
var map__10678__$1 = cljs.core.__destructure_map.call(null,map__10678);
var file = cljs.core.get.call(null,map__10678__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10678__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10678__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__10677_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10677_SHARP_));
...
var temp__5720__auto___10679 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10679)){
var message_10680 = temp__5720__auto___10679;
cljs.core.println.call(null,message_10680);
} else {
}
...
var temp__5720__auto___10681 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10681)){
var message_10682 = temp__5720__auto___10681;
cljs.core.println.call(null,message_10682);
} else {
}
...
var output_dir__$1 = (function (){var G__10683 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10683,"/"].join('');
} else {
return G__10683;
}
})();
...
var G__10684 = exception.stack;
var G__10684__$1 = (((G__10684 == null))?null:clojure.string.split_lines.call(null,G__10684));
var G__10684__$2 = (((G__10684__$1 == null))?null:cljs.core.get.call(null,G__10684__$1,depth));
if((G__10684__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10684__$2);
}
} else {
...
var vec__10685 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10685,(0),null);
var column = cljs.core.nth.call(null,vec__10685,(1),null);
var vec__10688 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10688,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10688,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10688,(2),null);
...
var m__$1 = (function (){var G__10691 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__10691__$1 = (((G__10691 instanceof cljs.core.Keyword))?G__10691.fqn:null);
switch (G__10691__$1) {
case "fail":
...
var G__10695 = (function (){var G__10694 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10694);
} else {
return G__10694;
}
})();
...
return cljs.core.vary_meta.call(null,G__10696,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10700 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10700,(0),null);
var types = vec__10700;
...
return cljs.core.map.call(null,(function (p__10703){
var vec__10704 = p__10703;
var ns = cljs.core.nth.call(null,vec__10704,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10704,(1),null);
return (function (){
...
var G__10707 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__10708 = cljs.core.seq.call(null,vars__$1);
var chunk__10709 = null;
var count__10710 = (0);
var i__10711 = (0);
while(true){
if((i__10711 < count__10710)){
var v = cljs.core._nth.call(null,chunk__10709,i__10711);
var temp__5720__auto___10713 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10713)){
var t_10714 = temp__5720__auto___10713;
each_fixture_fn.call(null,((function (seq__10708,chunk__10709,count__10710,i__10711,t_10714,temp__5720__auto___10713,v,each_fixture_fn,G__10707,G__10707__$1,env,once_fixtures,each_fixtures,vec__10704,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10714)));
});})(seq__10708,chunk__10709,count__10710,i__10711,t_10714,temp__5720__auto___10713,v,each_fixture_fn,G__10707,G__10707__$1,env,once_fixtures,each_fixtures,vec__10704,ns,vars__$1))
);
} else {
}


var G__10715 = seq__10708;
var G__10716 = chunk__10709;
var G__10717 = count__10710;
var G__10718 = (i__10711 + (1));
seq__10708 = G__10715;
chunk__10709 = G__10716;
count__10710 = G__10717;
i__10711 = G__10718;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__10708);
if(temp__5720__auto__){
var seq__10708__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10708__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__10708__$1);
var G__10719 = cljs.core.chunk_rest.call(null,seq__10708__$1);
var G__10720 = c__4679__auto__;
var G__10721 = cljs.core.count.call(null,c__4679__auto__);
var G__10722 = (0);
seq__10708 = G__10719;
chunk__10709 = G__10720;
count__10710 = G__10721;
i__10711 = G__10722;
continue;
} else {
var v = cljs.core.first.call(null,seq__10708__$1);
var temp__5720__auto___10723__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10723__$1)){
var t_10724 = temp__5720__auto___10723__$1;
each_fixture_fn.call(null,((function (seq__10708,chunk__10709,count__10710,i__10711,t_10724,temp__5720__auto___10723__$1,v,seq__10708__$1,temp__5720__auto__,each_fixture_fn,G__10707,G__10707__$1,env,once_fixtures,each_fixtures,vec__10704,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10724)));
});})(seq__10708,chunk__10709,count__10710,i__10711,t_10724,temp__5720__auto___10723__$1,v,seq__10708__$1,temp__5720__auto__,each_fixture_fn,G__10707,G__10707__$1,env,once_fixtures,each_fixtures,vec__10704,ns,vars__$1))
);
} else {
}


var G__10725 = cljs.core.next.call(null,seq__10708__$1);
var G__10726 = null;
var G__10727 = (0);
var G__10728 = (0);
seq__10708 = G__10725;
chunk__10709 = G__10726;
count__10710 = G__10727;
i__10711 = G__10728;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10707__$1)].join('')));
